...
ActiveRecord::Schema[7.1].define(version: 2024_09_11_024355) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.date "cf_dp"
    t.date "cf_dp_2"
    t.datetime "cf_dtp", precision: nil
    t.datetime "cf_dtp_2", precision: nil
  ...
  create_table "contacts", id: :serial, force: :cascade do |t|
    ...
    t.text "cf_cb"
    t.date "cf_date"
    t.datetime "cf_dt", precision: nil
    t.decimal "cf_nd"
    t.integer "cf_ni"
    t.float "cf_nfp"
    t.date "cf_dp"
